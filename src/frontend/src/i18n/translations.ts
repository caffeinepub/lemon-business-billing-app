...
export const translations = {
  en: {
    ...
    noCustomersDesc:
      "Start by adding your first customer to track lemon sales and credit.",
    ...
    deleteCreditPaymentDesc:
      "This will permanently delete this credit payment of",
    deleteCreditPaymentDesc2:
      "The customer's balance will be restored. This action cannot be undone.",
    ...
    deleteTransactionDesc2:
      "The customer's balance will be recalculated. This action cannot be undone.",
    ...
    loss: "LOSS",
    summaryNote:
      "Profit = Total Collected − Total Credit Due · Data updates in real-time",
  ...
  hi: {
    ...
    deleteCreditPaymentDesc2:
      "ग्राहक का बैलेंस पुनः स्थापित किया जाएगा। यह क्रिया पूर्ववत नहीं की जा सकती।",
    ...
    deleteTransactionDesc2:
      "ग्राहक का बैलेंस पुनः गणना किया जाएगा। यह क्रिया पूर्ववत नहीं की जा सकती।",
  ...
  mr: {
    ...
    deleteCustomerDesc2:
      "आणि त्यांचे सर्व व्यवहार. ही क्रिया पूर्ववत केली जाऊ शकत नाही.",
    delete: "हटवा",
    ...
    deleteCreditPaymentDesc2:
      "ग्राहकाची शिल्लक पुनर्संचयित केली जाईल. ही क्रिया पूर्ववत केली जाऊ शकत नाही.",
    ...
    deleteTransactionDesc2:
      "ग्राहकाची शिल्लक पुन्हा मोजली जाईल. ही क्रिया पूर्ववत केली जाऊ शकत नाही.",
  ...
  kn: {
    ...
    deleteCustomerDesc2:
      "ಮತ್ತು ಅವರ ಎಲ್ಲಾ ವ್ಯವಹಾರಗಳನ್ನು. ಈ ಕ್ರಿಯೆಯನ್ನು ರದ್ದುಮಾಡಲಾಗುವುದಿಲ್ಲ.",
    delete: "ಅಳಿಸಿ",
    ...
    deleteCreditPaymentDesc2:
      "ಗ್ರಾಹಕರ ಬ್ಯಾಲೆನ್ಸ್ ಮರುಸ್ಥಾಪಿಸಲಾಗುತ್ತದೆ. ಈ ಕ್ರಿಯೆಯನ್ನು ರದ್ದುಮಾಡಲಾಗುವುದಿಲ್ಲ.",
    ...
    deleteTransactionDesc2:
      "ಗ್ರಾಹಕರ ಬ್ಯಾಲೆನ್ಸ್ ಮರು ಲೆಕ್ಕಾಚಾರ ಮಾಡಲಾಗುತ್ತದೆ. ಈ ಕ್ರಿಯೆಯನ್ನು ರದ್ದುಮಾಡಲಾಗುವುದಿಲ್ಲ.",
