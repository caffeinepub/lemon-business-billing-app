          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">
                {fmt(transaction.lemonQuantity)} pcs × ₹
                {fmt(transaction.ratePerUnit)}
              </span>
            </div>
            <div className="flex items-center gap-3 mt-1">
              ...
              <span
                className={`font-extrabold text-sm ${hasCredit ? "text-orange-600" : "text-lemon-green-dark"}`}
              >
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {t("deleteTransactionDesc")} <strong>{date}</strong> (₹
                {fmt(transaction.totalAmount)}). {t("deleteTransactionDesc2")}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <div className="border-t border-border bg-muted/20 px-4 py-3 space-y-2">
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              ...
              <p className="font-bold text-lemon-green-dark">
            ...
            <div>
              ...
              <p
                className={`font-extrabold ${hasCredit ? "text-orange-600" : "text-lemon-green-dark"}`}
              >
