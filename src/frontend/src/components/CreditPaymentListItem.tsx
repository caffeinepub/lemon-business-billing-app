...
export default function CreditPaymentListItem({
  ...
  const date = new Date(
    Number(payment.transactionDate) / 1_000_000,
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {t("deleteCreditPaymentDesc")} ₹{fmt(payment.paymentAmount)} (
                {date}). {t("deleteCreditPaymentDesc2")}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <div className="border-t border-blue-100 bg-blue-50/40 px-4 py-3 space-y-2">
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div>
              ...
              <p
                className={`font-extrabold ${payment.resultingCreditBalance > 0 ? "text-orange-600" : "text-lemon-green-dark"}`}
              >
