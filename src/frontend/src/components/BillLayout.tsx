    ...
    <div className="bill-content bg-white rounded-2xl border-2 border-lemon-yellow-dark/40 shadow-lg overflow-hidden">
      ...
      <div className="bg-lemon-yellow px-6 py-5 text-center print:bg-white print:border-b-2 print:border-gray-800">
        <div className="flex items-center justify-center gap-2 mb-1">
          ...
          />
          <h2 className="text-lemon-dark font-extrabold text-xl tracking-tight">
            🍋 {t("appTitle")}
          </h2>
        </div>
        <p className="text-lemon-dark/60 text-sm font-medium">
          {t("salesBill")}
        </p>
        <p className="text-lemon-dark/50 text-xs mt-1">
          {t("billDate")}: {date}
        </p>
      </div>
        ...
        <div className="space-y-2.5">
          <div className="flex justify-between items-center">
            ...
            <span className="font-bold text-foreground">
              {transaction.lemonQuantity.toFixed(2)} pcs
            </span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-sm text-muted-foreground">
      ...
      <div className="px-6 py-4">
        ...
        <div className="space-y-2.5">
          ...
          >
            <span className="font-bold text-foreground">
              {t("netCreditBalanceLabel")}
            </span>
            <span
              className={`font-extrabold text-xl ${hasCredit ? "text-orange-600" : "text-lemon-green-dark"}`}
            >
